                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    <div className="lg:w-2/3">
                        <div className="mb-8 flex items-center">
                            <h1 className="text-2xl font-bold text-[#c19a6b]">LUXE</h1>

                            <div className="w-px h-8 bg-[#c19a6b] mx-2"></div> {/* Gạch dọc */}

                            <h1 className="text-[#c19a6b] text-xl">THÔNG TIN THANH TOÁN</h1>
                        </div>
                    <form action="">
                        <div className="progress-container">
                            ...
                            <div className="step step-3">
                                ...
                                <span className="step-text">Thanh toán thành công</span>
                            </div>
                        </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input type="text" placeholder="1234 5678 9012 3456"
                                        className="w-full border border-gray-200 px-4 py-2 focus:outline-none focus:border-1 focus:border-[#c19a6b]" />
                                </div>
                        ...
                        <div className="flex justify-between mt-8">
                            <Link href="/cart" className="text-primary hover:text-[#c19a6b] transition flex items-center">
                                <IoIosArrowRoundBack />
                                Trở lại giỏ hàng
                            </Link>
                            <button
                                className="bg-[#c19a6b] cursor-pointer text-white px-8 py-3 hover:opacity-80 transition uppercase font-medium tracking-wider">
                                XÁC NHẬN THANH TOÁN
                            </button>
                        </div>
                    </form>
                        ...
                        <div className="border border-gray-200 p-6 sticky top-32">
                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-[#c19a6b]">400.000 đ</span>
                                </div>
