...
export default function HeaderNav() {
  ...
  return (
    <div>
      ...
      <div
        ref={sidebarRef}
        className={`fixed top-0 left-0 h-full w-64 bg-white text-gray-900 z-50 transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
        {/* Nội dung sidebar */}
        <div className="p-6">
          <button
            ...
            className="flex items-center text-base mb-8 cursor-pointer"
          >
          ...
          <ul className="space-y-4">
            <li className="relative group">
              ...
              <span className="absolute left-0 bottom-0 w-0 h-[1px] bg-[#C19A6B] group-hover:w-full transition-all duration-500"></span>
            </li>
            <li className="relative group">
              <Link
                href=""
            ...
            <hr></hr>
            <div className="text-lg">Phát triển bền vững</div>
            <li className="relative group">
              <Link
                href=""
                onClick={closeSidebar}
