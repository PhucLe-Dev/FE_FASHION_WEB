    ...
    <div ref={wrapperRef} className="relative block text-sm font-medium text-gray-700 mb-1">
      ...
      {isOpen && (
        <div className="absolute top-full mt-1 w-full bg-white border shadow-lg z-10">
          ...
          <div className="flex">
            <button
              className={`flex-1 py-2 text-sm ${tab === "province" ? "border-b-2 border-[#c19a6b] text-[#c19a6b]" : ""}`}
              onClick={() => setTab("province")}
            >
              Tỉnh/Thành phố
            </button>
            <button
              className={`flex-1 py-2 text-sm ${tab === "district" ? "border-b-2 border-[#c19a6b] text-[#c19a6b]" : ""}`}
            ...
            <button
              className={`flex-1 py-2 text-sm ${tab === "ward" ? "border-b-2 border-[#c19a6b] text-[#c19a6b]" : ""}`}
