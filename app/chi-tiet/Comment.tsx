    ...
    <div id="comment-section" className="container mx-auto px-6 py-10">
      ...
      <div className="mb-8 bg-white shadow-lg p-6">
        ...
        <form onSubmit={handleSubmitComment}>
          <textarea
            id="comment"
            className="w-full p-4 text-sm text-gray-800 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#C19A6B] transition-all duration-300 resize-none"
          ...
          <button
            type="submit"
            className="mt-3 px-5 py-2 bg-transparent border border-[#C19A6B] text-[#C19A6B] hover:bg-[#C19A6B] hover:text-white transition-all duration-300 font-medium tracking-wide"
          >
            Đăng bình luận
          </button>
        </form>
            ...
            <article className="p-6 bg-white shadow-md">
              ...
              {editComment[comment.id] ? (
                <div className="mb-3">
                  ...
                  <button
                    ...
                    className="mt-2 px-5 py-2 bg-transparent border border-[#C19A6B] text-[#C19A6B] hover:bg-[#C19A6B] hover:text-white transition-all duration-300 font-medium tracking-wide"
                  >
                    Lưu
                  </button>
                </div>
              ...
              <div className="flex items-center mt-4 space-x-4">
                <button
                  ...
                  className="flex items-center text-sm text-gray-600 hover:text-[#C19A6B] transition-all duration-200 font-medium"
                >
                  <svg
                ...
                {comment.replies.length > 0 && (
                  <button
                    ...
                    className="text-sm text-[#C19A6B] hover:underline transition-all duration-200 font-medium"
                  >
