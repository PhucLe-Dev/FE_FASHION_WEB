                    ...
                    <div className="grid md:grid-cols-2">
                        ...
                        <div className="p-10 bg-white">
                            <div className="flex justify-between items-center">
                                ...
                                <Link href="/sign-in-qr-code">
                                    <BsQrCodeScan className="text-6xl text-[#c19a6b] cursor-pointer ml-5" />
                                </Link>
                            </div>
                            <form>
                                <div className="my-6">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="flex justify-between items-center mt-2">
                                        ...
                                        <a href="#" className="text-sm text-accent hover:underline">Bạn quên mật khẩu?</a>
                                    </div>
                                </div>
