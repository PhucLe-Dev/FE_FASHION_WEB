                    ...
                    <div className="md:w-1/4">
                        <div className="bg-white shadow-sm p-6 sticky top-32">
                                    ...
                                    {showMenu && (
                                        <ul className="absolute top-20 w-36 bg-white flex flex-col shadow-lg text-sm text-gray-800 z-10 animate-fade-in">
                                            <li className="px-4 py-2 hover:bg-gray-100 transition duration-200 cursor-pointer">
                                                <Link href="#" className="flex item-center hover:text-[#c19a6b]"><ImUpload2 className="mr-2 text-lg" /> Tải ảnh lên</Link>
                                            </li>
                                            <li className="px-4 py-2 hover:bg-gray-100 transition duration-200 cursor-pointer">
                                                <Link href="#" className="flex item-center hover:text-[#c19a6b]"><CiTrash className="mr-2 text-lg" /> Xóa ảnh</Link>
                                            </li>
                                        </ul>
                                    )}
                                </div>
                            ...
                            <button
                                ...
                                className={`flex items-center py-3 px-4 font-medium transition ${activeTab === "profile"
                                    ? "text-[#c19a6b] bg-gray-50"
                                    : "text-gray-600 hover:text-[#c19a6b] hover:bg-gray-50"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center py-3 px-4 font-medium transition ${activeTab === "orders"
                                    ? "text-[#c19a6b] bg-gray-50-md"
                                    : "text-gray-600 hover:text-[#c19a6b] hover:bg-gray-50"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center py-3 px-4 font-medium transition ${activeTab === "address"
                                    ? "text-[#c19a6b] bg-gray-50-md"
                                    : "text-gray-600 hover:text-[#c19a6b] hover:bg-gray-50"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center py-3 px-4 font-medium transition ${activeTab === "logout"
                                    ? "text-[#c19a6b] bg-gray-50-md"
                                    : "text-gray-600 hover:text-[#c19a6b] hover:bg-gray-50"
                                    }`}
                            >
