    ...
    return (
        <div className="relative min-h-screen">
            ...
            <div className="absolute top-0 left-0 w-full h-full z-0">
                ...
                >
                    <source
                        src="https://vod.freecaster.com/louisvuitton/9c29c167-aae5-4072-ba95-2e11705b0c18/qAlihGwwVh_4.mp4"
                        type="video/mp4"
                    />
                </video>
            ...
            <div className="relative z-10 min-h-screen text-white">
                        ...
                        {milestones.map((milestone) => (
                            <li key={milestone.year}>
                                <a
                                    ...
                                    className="text-[#c19a6b] hover:text-white transition-colors duration-300 text-sm"
                                >
                                    {milestone.year}
                                </a>
                            </li>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-8">
                            ...
                            <div className="lg:w-1/2 mt-8 lg:mt-0">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <div className="flex-1 border-l-2 border-[#c19a6b] pl-3 py-1">
                                        <h3 className="font-medium text-[#c19a6b] mb-1 text-sm">Tầm nhìn</h3>
                                        <p className="text-gray-400 text-sm">
                                            Để xác định lại sự sang trọng hiện đại thông qua thiết kế vượt thời gian và sự khéo léo đặc biệt.
                                        </p>
                                    </div>
                                    <div className="flex-1 border-l-2 border-[#c19a6b] pl-3 py-1">
                                        <h3 className="font-medium text-[#c19a6b] mb-1 text-sm">Xứ mệnh</h3>
                                        <p className="text-gray-400 text-sm">
                    ...
                    <div className="container mx-auto px-4 sm:px-6">
                        ...
                        <div className="relative max-h-[600px] overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                            <div className="relative pb-12">
                                <div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-[#c19a6b]/20"></div>
                                {milestones.map((milestone, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                className="p-4 bg-gray-900/80 rounded-lg border border-[#c19a6b]/20 transform transition-all duration-800 hover:scale-105 opacity-0"
                                        ...
                                        <div className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-[#c19a6b] rounded-full flex items-center justify-center border-2 border-white/50 z-10">
                    ...
                    <div className="container mx-auto px-4 sm:px-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="text-center p-4 bg-gray-900/70 rounded-lg">
                                <div
                                    className="w-12 h-12 bg-[#c19a6b]/10 rounded-full flex items-center justify-center mx-auto mb-4"
                                    data-aos="fade-up"
                                >
                                    <span className="text-xl text-[#c19a6b]">💎</span>
                                </div>
                                <h3 className="font-medium text-[#c19a6b] mb-2 text-sm">Vật liệu đặc biệt</h3>
                                <p className="text-gray-400 text-sm">
                            ...
                            <div className="text-center p-4 bg-gray-900/70 rounded-lg">
                                ...
                                <h3 className="font-medium text-[#c19a6b] mb-2 text-sm">Thủ công tinh xảo</h3>
                            ...
                            <div className="text-center p-4 bg-gray-900/70 rounded-lg">
                                ...
                                <h3 className="font-medium text-[#c19a6b] mb-2 text-base">Xa xỉ bền vững</h3>
                                <p className="text-gray-400 text-base">
                    ...
                    <div className="container mx-auto px-4 sm:px-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="text-center p-4 bg-gray-900/70 rounded-lg">
                                ...
                                <h3 className="font-medium text-[#c19a6b] mb-1 text-sm">Sophie Laurent</h3>
                            ...
                            <div className="text-center p-4 bg-gray-900/70 rounded-lg">
                                ...
                                >
                                    <img
                                        src="https://plus.unsplash.com/premium_photo-1675130119373-61ada6685d63?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjF8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D"
                                        alt="Founder Two"
                                        className="w-full h-full object-cover"
                                    />
                                </div>
                                <h3 className="font-medium text-[#c19a6b] mb-1 text-sm">James Montgomery</h3>
                                <p className="text-gray-400 text-xs mb-2">CEO</p>
                                <p className="text-gray-400 text-sm">
                                    Với nền tảng về quản lý bán lẻ sang trọng, James giám sát các hoạt động toàn cầu của Luxe.
                                </p>
                            </div>
                            <div className="text-center p-4 bg-gray-900/70 rounded-lg">
                                <div
                                ...
                                <h3 className="font-medium text-[#c19a6b] mb-1 text-sm">Chae Soo Bin</h3>
                ...
                <section className="py-16 sm:py-24 bg-[url(https://vn.louisvuitton.com/content/dam/lv/online/high-end/wolv/sustainability/U_Su_Committed_Journey_v2.html/jcr:content/assets/background_DI3.jpg?imwidth=1090)] no-repeat bg-cover bg-center bg-fixed">
                    <div className="container mx-auto px-4 sm:px-6 text-center">
                        ...
                        <Link
                            href="/products"
                            className="inline-block bg-white text-[#c19a6b] px-6 py-2 font-medium rounded-full hover:bg-gray-100 transition-all duration-300"
                            data-aos="fade-up"
                            data-aos-delay="400"
                        >
        ...
        .scrollbar-thumb-[#c19a6b]\/50::-webkit-scrollbar-thumb {
