                    ...
                    <div className="grid md:grid-cols-2">
                        ...
                        <div className="p-10 bg-white">
                            ...
                            <form>
                                ...
                                <button type="submit"
                                    className="w-full py-3 bg-[#e6b67b] text-white font-medium cursor-pointer hover:bg-[#e6b67bce] transition delay-10 mb-6">
                                    Đăng Ký
                                </button>
                                ...
                                <p className="text-center text-gray-500">
                                    Bằng việc đăng kí, bạn đã đồng ý với LUXE về <Link href="/register" className="text-[#c19a6b] hover:underline">Điều khoản dịch vụ </Link>
                                    & <Link href="/register" className="text-[#c19a6b] hover:underline">Chính sách bảo mật</Link>
                                </p>

                                <p className="text-center text-gray-500">
                                    Bạn đã có tài khoản LUXE? <Link href="/sign-in" className="text-[#c19a6b] hover:underline">Đăng nhập ngay</Link>
                                </p>
                            </form>
                        </div>
                    </div>
