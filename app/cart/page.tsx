            ...
            <section className="pt-30 pb-20">
                <div className="container mx-auto px-6">
                    <div className="mb-8 flex items-center">
                        ...
                        <h1 className="text-[#c19a6b] text-xl">GIỎ HÀNG</h1>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        <div className="lg:w-2/3">
                            ...
                            <table className="w-full border border-gray-200 bg-white overflow-hidden">
                                ...
                                <tbody className="grid grid-cols-6 gap-4 px-4 py-2 justify-items-center items-center">
                                    ...
                                    <td className="col-span-1 text-right">
                                        <MdOutlineClear className="hover:text-[#c19a6b] cursor-pointer" />
                                    </td>
                                </tbody>
                            ...
                            <div className="flex justify-between mt-6">
                                <Link href='' className="cursor-pointer hover:text-[#c19a6b] hover:underline flex items-center">
                                    <IoIosArrowRoundBack />
                                    Tiếp tục mua sắm
                                </Link>
                                <button className="items-center cursor-pointer hover:text-[#c19a6b] hover:underline">
                                    Xóa tất cả giỏ hàng
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/3">
                            <div className="border border-gray-200 bg-white p-6">
                                ...
                                <Link href='/payment'
                                    className="block text-center py-2 w-full cursor-pointer bg-[#c19a6b] text-white hover:opacity-80 transition">
