    ...
    const renderPaginationButtons = () => {
        ...
        pageButtons.push(
            <button
                ...
                className={`w-10 h-10 flex items-center justify-center mx-0.5
                    ${pagination.currentPage === 1 || isLoading ? 'text-gray-400 cursor-not-allowed' : 'text-gray-700 hover:bg-[#c19a6b] hover:text-white cursor-pointer'}
                    transition-colors`}
            >
                <BsChevronLeft />
            </button>
        ...
        if (startPage > 1) {
            pageButtons.push(
                <button
                    ...
                    disabled={isLoading}
                    className={`w-10 h-10 flex items-center justify-center mx-0.5 ${isLoading ? 'text-gray-400 cursor-not-allowed' : 'text-gray-700 hover:bg-[#c19a6b] hover:text-white'} transition-colors`}
                >
                    1
                </button>
            );
        ...
        for (let i = startPage; i <= endPage; i++) {
            pageButtons.push(
                <button
                    ...
                    disabled={isLoading}
                    className={`w-10 h-10 flex items-center justify-center mx-0.5
                      ${pagination.currentPage === i ? 'bg-[#c19a6b] text-white border-[#c19a6b]' : isLoading ? 'text-gray-400 cursor-not-allowed' : 'text-gray-700 hover:bg-[#c19a6b] hover:text-white cursor-pointer'}
        ...
        pageButtons.push(
            <button
                ...
                className={`w-10 h-10 flex items-center justify-center mx-0.5
                    ${pagination.currentPage === pagination.totalPages || isLoading ? 'text-gray-400 cursor-not-allowed' : 'text-gray-700 hover:bg-[#c19a6b] hover:text-white cursor-pointer'}
                    transition-colors`}
            >
                <BsChevronRight />
            </button>
            ...
            <div className="container mx-auto px-6">
                <div className="flex gap-6">
                    ...
                    >
                        ...
                        <div className="font-semibold flex items-center text-[#c19a6b] mb-4 border-b pb-2">
                        ...
                        <ul className={`space-y-2 text-base mb-6 transition-all duration-300 ${showMoreCategories ? '' : 'max-h-[150px] overflow-hidden'}`}>
                            {categories.map(item => (
                                <li key={item}>
                                    <label className="block hover:text-[#c19a6b] cursor-pointer">
                                        <input
                                            type="checkbox"
                        ...
                        <div className="font-semibold flex items-center text-[#c19a6b] mb-2 border-b pb-2">
                    ...
                    <div className="flex-1 w-full">
                        <div className="flex items-center justify-between bg-white border border-gray-200 p-3 mb-6 text-base">
                            <div className="flex items-center gap-1 flex-wrap">
                                <button
                                    className="md:hidden flex items-center gap-1 border border-[#c19a6b] text-[#c19a6b] px-3 py-1 hover:bg-[#c19a6b]/10"
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 ${sortType === 'all'
                                        ...
                                        : 'bg-[#f8f8f8] border border-[#f5f5f5] hover:border-[#c19a6b]'
                                ...
                                <select
                                    ...
                                    className="bg-[#f8f8f8] border border-[#f5f5f5] px-3 py-1 hover:border-[#c19a6b] transition cursor-pointer outline-none"
                                >
                            ...
                            <div className="flex items-center gap-0.5">
                                <div className="">
                                    <span className="text-[#c19a6b] font-semibold">{pagination.currentPage}</span>
                                    <span>/{pagination.totalPages}</span>
                                </div>
                                <button
                                    onClick={() => setPagination(prev => ({ ...prev, currentPage: Math.max(1, prev.currentPage - 1) }))}
                                    disabled={pagination.currentPage === 1 || isLoading}
                                    className={`outline-none bg-[#f8f8f8] px-4 py-1 hover:bg-[#c19a6b] hover:text-white cursor-pointer transition
